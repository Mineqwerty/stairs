...
const LevelScript level_sl_entry[] = {
	...
	AREA(1, sl_area_1),
		...
		OBJECT(MODEL_BREAKABLE_ICE, -4445, 4557, -3854, 0, 0, 0, 0x00000000, bhvBreakableIce),
		OBJECT(MODEL_NONE, 3735, 5574, -5418, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 3735, 5574, -5418),
	...
	AREA(2, sl_area_2),
		...
		WARP_NODE(0xF0, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 3735, 10234, -5418, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
