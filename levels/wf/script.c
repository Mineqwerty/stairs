...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_RHINO, 0, 0, 0, 0, 0, 0, 0x00000000, bhvRhino),
		OBJECT(MODEL_ELEPHANT, -12781, -5036, 7618, 0, 73, 0, 0x00000000, bhvElephant),
		OBJECT(MODEL_ELEPHANT, -1637, -3234, -6405, 0, 0, 0, 0x00000000, bhvElephant),
		OBJECT(MODEL_ELEPHANT, 2846, -2995, -4331, 0, 0, 0, 0x00000000, bhvElephant),
		OBJECT(MODEL_ELEPHANT, -15730, -2121, -9944, 0, 161, 0, 0x00000000, bhvElephant),
		OBJECT(MODEL_ELEPHANT, -1976, -2583, -12673, 0, -100, 0, 0x00000000, bhvElephant),
		OBJECT(MODEL_WARP_STAIRS, 12325, 1717, -9414, 0, -35, 0, 0x00000000, bhvWarpStairs),
		OBJECT(MODEL_NONE, -14941, -5314, 15988, 0, 73, 0, 0x00000000, bhvMarioStairsController),
		OBJECT(MODEL_NONE, -16323, -5997, 16650, 0, 12, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 12, -16323, -5997, 16650),
		TERRAIN(wf_area_1_collision),
		MACRO_OBJECTS(wf_area_1_macro_objs),
		SET_BACKGROUND_MUSIC(0x00, SEQ_STREAMED_MOUNTAIN),
